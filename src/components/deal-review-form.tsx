  ...
  return (
    <form onSubmit={submit} className="grid max-w-2xl gap-5 rounded-lg border border-zinc-200 bg-white p-6">
      <div>
        ...
        <h1 className="mt-1 text-2xl font-semibold text-zinc-950">{t("reviews.writeFeedback")}</h1>
      ...
      <button className="w-fit rounded-md bg-zinc-950 px-4 py-2.5 text-sm font-medium text-white">{t("reviews.submitFeedback")}</button>
    </form>
  );
}
