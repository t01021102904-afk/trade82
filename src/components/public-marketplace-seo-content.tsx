...
const sellersCopy = {
  en: {
    ...
    description:
      "Review Korean manufacturers, brand owners, distributors, their products, export experience, certifications, and company information before making contact.",
  },
  ko: {
    title: "한국 공급사",
    description:
      "한국 제조사, 브랜드사, 유통사의 상품, 수출 경험, 인증 및 회사 정보를 검토한 뒤 문의하세요.",
  },
} as const;
...
function CompactPageHeader({
  ...
  return (
    <header className="grid gap-3 border-b border-zinc-200 pb-5 lg:grid-cols-[0.7fr_1.3fr] lg:items-end">
      <h1
        id={headingId}
        className="text-2xl font-semibold tracking-[-0.04em] text-zinc-950 sm:text-4xl"
      >
        {title}
      </h1>
