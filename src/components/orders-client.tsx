...
export function OrderDetailClient({ orderNumber, locale: pageLocale }: { orderNumber: string; locale?: "en" | "ko" }) {
  ...
  if (loading) return <main className="mx-auto max-w-6xl px-4 py-10"><CometSpinner size="xs" /></main>;
