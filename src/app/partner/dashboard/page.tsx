...
export default async function PartnerDashboardPage({ searchParams }: { searchParams: Promise<Record<string, string | string[] | undefined>> }) {
  ...
  return <PartnerDashboardView locale="en" data={data} referralUrl={`${getAppUrl().replace(/\/$/, "")}/r/${partner.referralCode}`} />;
}
